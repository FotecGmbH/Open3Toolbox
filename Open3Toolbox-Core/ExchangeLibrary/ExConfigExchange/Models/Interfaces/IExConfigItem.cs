...
namespace ExConfigExchange.Models.Interfaces
{
    ...
    ///     ### Sollte eine neue Implementierung von diesem Interface zugefügt werden, muss dieses mit hilfe des
    ///     <see cref="ExJsonInheritanceAttribute" /> hier addiert werden! ###
    /// </summary>
    ...
    public interface IExConfigItem : IBissSerialize, INotifyPropertyChanged
    {
        ...
        ///     Wird für die weiter passen von Information zu den Kindern des Configs verwendet (e.g.: Delete Button bei
        ///     <see cref="ExCollectionConfigItem" />).
        /// </param>
        /// <returns>
