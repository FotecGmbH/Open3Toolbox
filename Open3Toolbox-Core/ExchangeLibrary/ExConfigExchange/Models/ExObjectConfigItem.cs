...
{
    /// <summary>
    ///     Diese Klasse representiert einen <see cref="class" /> (Non-collection-referenz Type) Property/Field von einen
    ///     abgebildeten Type.
    /// </summary>
    ...
    public class ExObjectConfigItem : IExConfigItem
    {
        ...
        /// <summary>
        ///     Dieses Key here wird, wenn <see cref="!null" /> verwendet um den benutzer zu erlauben zwischen objekte zu
        ///     unterscheiden und zu bennenen.
        ...
        /// </summary>
        /// <value>
        ///     <c>true</c> wenn <see cref="ConfigureAsAttribute" /> vorhanden war im abgebildeten Property/Field; sonst,
        ///     <c>false</c>.
        /// </value>
        public bool HadConfigureAsAttribute { get; set; }

        /// <summary>
        ///     <c>true</c> wenn der Property/Field einen interface war oder so zu verstehen war(<see cref="InterfaceAttribute" />
        ///     ); sonst, <c>false</c>.
        /// </summary>
        public bool IsInterface { get; set; }

        /// <summary>
        ///     <c>true</c> wenn <see cref="IsInterface" /> == <c>true</c> und der ursprüngliche Field/Property und mit
        ///     <see cref="ImplementationRequiredAttribute" /> markiert wurde.
        /// </summary>
        ...
        /// <summary>
        ///     Properties/Fields die aus der abgebildeten Type durch reflection ausgelesen wurden. (Sehe
        ///     <see cref="Services.ExConfigItemManager" />)
        ...
        /// <summary>
        ///     Der Name des abgebildeten Interfaces, wird für das Abfragen der Implementationen verwendet
        ///     <see cref="Services.ExConfigItemManager.GetTemplatesFor(string)" />
        /// </summary>
