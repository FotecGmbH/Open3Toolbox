...
{
    /// <summary>
    ///     Table für final Unteransichten.
    /// </summary>
    [Table("TblFinalSubView")]
    public class TableFinalSubView
    {
        #region Properties
        ...
        /// <summary>
        ///     Die Aktoren die zu diesem final Unteransicht gehören.
        /// </summary>
        [ForeignKey(nameof(TableActorView.FinalSubViewId))]
        public ICollection<TableActorView> Actors { get; set; } = new List<TableActorView>();

        /// <summary>
        ///     Die Messungen die zu diesem final Unteransicht gehören.
        /// </summary>
        [ForeignKey(nameof(TableMeasurementView.FinalSubViewId))]
        public ICollection<TableMeasurementView> Measurements { get; set; } = new List<TableMeasurementView>();
