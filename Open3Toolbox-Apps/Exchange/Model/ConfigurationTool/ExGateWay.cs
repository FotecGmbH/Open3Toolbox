...
{
    /// <summary>
    ///     Der konfigurierbaren Gateway Modell.
    /// </summary>
    /// <seealso cref="Exchange.Model.ConfigurationTool.Interfaces.IExConfigurable" />
    public class ExGateway : IExConfigurable
    {
        #region Properties

        /// <summary>
        ///     Der Id vom Projekt dem, dieser Gateway zugehört.
        /// </summary>
        ...
        //public Comunication ComToSens { get; set; } = Comunication.Udp; 
