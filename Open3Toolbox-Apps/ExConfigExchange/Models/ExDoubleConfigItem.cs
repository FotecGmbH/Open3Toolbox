...
{
    /// <summary>
    /// Diese Klasse representiert einen <see cref="double"/> Property/Field von einen abgebildeten Type.
    /// </summary>
    /// <seealso cref="ExConfigExchange.Models.Interfaces.IExConfigItem" />
    public class ExDoubleConfigItem : IExConfigItem
    {
        /// <summary>
        ...
        /// Der Validen berreich in dem der Wert liegen kann mit inklusiven <see cref="ExRange.Min"/> und <see cref="ExRange.Max"/>. <br/>
        /// Um <see cref="Value"/> als valid erkannt zu werden, muss: <see cref="Value"/> % <see cref="ExRange.Step"/> == 0 => <see cref="true"/> sein.
        /// </summary>
