...
{
    /// <summary>
    /// Diese Klasse representiert einen <see cref="string"/> Property/Field von einen abgebildeten Type.
    /// </summary>
    /// <seealso cref="ExConfigExchange.Models.Interfaces.IExConfigItem" />
    public class ExStringConfigItem : IExConfigItem
    {
        /// <summary>
        ...
        /// <summary>
        /// Der <see cref="System.Text.RegularExpressions.Regex"/>-Pattern für Input validierung, kann mit hilfe von <see cref="RegexAttribute"/> gesetzt werden.
        /// </summary>
        ...
        /// Wird hauptsächlich für den DisplayName verwendet.
        /// </summary>
