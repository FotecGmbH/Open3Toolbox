...
namespace ExConfigExchange.Services.Interfaces
{
    ...
    /// Man kann diese für die Rendering oder allgemeine Unterscheidung von <see cref="IExConfigItem"/> implementationen verwenden.
    /// </summary>
    ...
    public interface IExConfigVisitor<TOut>
    {
        ...
        /// <param name="optionalCall">Mit dieser <see cref="Func"/> kann man werte vom Eltern zum Kind <see cref="IExConfigItem"/> verpasst werden.</param>
        ...
        /// </summary>
        /// <param name="exEnumConfigItem">Der <see cref="IExConfigItem"/> Abbildung vom Type: <see cref="enum"/>.</param>
        /// <param name="optionalCall">Mit dieser <see cref="Func"/> kann man werte vom Eltern zum Kind <see cref="IExConfigItem"/> verpasst werden.</param>
        /// <returns><see cref="TOut"/></returns>
