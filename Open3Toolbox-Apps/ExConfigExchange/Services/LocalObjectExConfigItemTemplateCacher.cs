...
namespace ExConfigExchange.Services
{
    ...
    {
        /// <summary>
        /// Die gechache-te <see cref="interface"/> Objekt Vorlagen (Implementationen) gemappt zum <see cref="Type.FullName"/> vom <see cref="interface"/>.
        /// </summary>
        private static ConcurrentDictionary<string, ConcurrentBag<ExObjectConfigItem>> _implementations = new ConcurrentDictionary<string, ConcurrentBag<ExObjectConfigItem>>();

        /// <summary>
        /// Die gechache-te Objekt Vorlagen.
        /// </summary>
        private static ConcurrentDictionary<string, ExObjectConfigItem> _objects = new ConcurrentDictionary<string, ExObjectConfigItem>();
