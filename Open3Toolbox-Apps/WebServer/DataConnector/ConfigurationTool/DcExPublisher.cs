...
namespace WebServer.DataConnector
{
    ...
    public partial class ServerRemoteCalls
    {
        ...
        /// <summary>
        ///     Erhalten des vorbereiteten Projektes
        /// </summary>
        /// <param name="newUserId">Benutzer id</param>
        /// <param name="carrier">Dc Liste der Items</param>
        /// <returns>Das Projekt</returns>
        public Project GetPrepProject(long newUserId, DcStoreListItem<ExProject> carrier)
        {
            ...
            return PrepareProject(carrier.Index, cachedProject, pGateways, pSensors);
        }
            ...
            return new TablePublishedActor
                   {
                       ...
                       Id = actor.Id,
                       Port = actor.Port,
                       SetterType = ActorSetterType.Range, // Dummy
                       Value = 0, // Dummy
                   };
        }
        ...
        /// <returns>
        ///     Die Index (<see cref="Project.Id" />) <-> Modell Projekt (<see cref="ExProject" />) Paare.
        /// </returns>
        ...
        /// <returns>
        ///     Die Index (<see cref="Gateway.Id" />) <-> Modell Gateway (<see cref="ExGateway" />) Paare.
        /// </returns>
        ...
        /// <returns>
        ///     Die Index (<see cref="Sensor.Id" />) <-> Modell Sensor (<see cref="ExSensor" />) Paare.
        /// </returns>
