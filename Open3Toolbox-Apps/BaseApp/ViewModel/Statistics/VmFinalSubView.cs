...
{
    /// <summary>
    ///     ViewModel vom FinalSubView (Final Unteransicht)
    /// </summary>
    /// <seealso cref="BaseApp.ViewModel.Statistics.Interfaces.IVmSubView" />
    public class VmFinalSubView : IVmSubView
    {
        /// <summary>
        ///     Initializes a new instance of the <see cref="VmFinalSubView" /> class.
        /// </summary>
        public VmFinalSubView()
        {
        }
        ...
        public VmFinalSubView(DcListDataPoint<ExFinalSubView> dataPoint)
        {
        ...
        /// </summary>
        public DcListDataPoint<ExFinalSubView> DataPoint { get; } = new DcListDataPoint<ExFinalSubView>(new ExFinalSubView());
        ...
        public IVmSubView Clone() =>
            new VmFinalSubView(new DcListDataPoint<ExFinalSubView>(BissDeserialize.FromJson<ExFinalSubView>(DataPoint.Data.ToJson())));
